...
export const LogoRow = () => {
    return (
        <section
            className="logo-marquee relative z-10 mx-auto mt-10 w-full max-w-[1480px] overflow-hidden px-1 pb-4 text-[1rem] font-extrabold tracking-[-0.03em] text-[rgba(34,36,44,0.62)] lg:absolute lg:bottom-[66px] lg:left-1/2 lg:mt-0 lg:-translate-x-1/2 lg:px-0 lg:pb-0"
